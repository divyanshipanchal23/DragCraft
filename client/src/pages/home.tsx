        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 shadow overflow-hidden rounded-lg">
            ...
            <div className="p-8 text-center">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Transform your ideas into reality</h3>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              <div className="w-12 h-12 rounded-full bg-primary bg-opacity-10 dark:bg-opacity-20 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Easy to Use</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Customizable Templates</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Responsive Design</h3>
              <p className="text-gray-600 dark:text-gray-300">
